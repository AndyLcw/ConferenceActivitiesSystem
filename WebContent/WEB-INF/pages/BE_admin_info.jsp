...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form action="updateAdmin.action" method="post" class="form-x" enctype="multipart/form-data">
      ...
      <div class="form-group">
        <div class="label">
          <label for="sitename">管理员头像：</label>
        </div>
        <div class="field">
          <input type="file" name="adminIcon" class="input w50" >
        </div>
      </div>        
      <div class="form-group">
        <div class="label">
