...
<form method="post" action="" id="listform">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 签到数据管理</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
    ...
    <table class="table table-hover text-center">
      ...
      <c:forEach var="conf" items="${AllOpenSignConference}">
            <tr>
		      	<td>${conf.confId}</td>
		        ...
		        <td>
					<div class="button-group">
		        		<a class="button border-main" href="selectAllSignUserData.action?signId=${conf.signId}"><span class="icon-eye"></span> 签到数据</a>
		        	</div>
		        </td>
      		</tr>
      </c:forEach>
