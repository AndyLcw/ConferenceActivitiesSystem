...
<form method="post" action="" id="listform">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 签到数据</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
    ...
    <table class="table table-hover text-center">
      ...
      <c:forEach var="signData" items="${SignUserData}">
            <tr>
		      	<td>${signData.userName}</td>
		        <td>${signData.userCollege}</td>
		        <td>${signData.stuNumber}</td>
		        <td>
		        	<fmt:formatDate value="${signData.signTime}" pattern="yyyy-MM-dd HH:mm:ss"/>
		        </td>
      		</tr>
      </c:forEach>
      <!-- 之后修改 -->
