...
<form method="post" action="" id="listform">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 报名管理</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
            ...
            <tr>
		        ...
		        <td>
		        	<div class="button-group">
		        		<a class="button border-main" href="jumpTo_BE_apply_add.action?confId=${conf.confId}&confIntro=${conf.confIntro}">
		        		<span class="icon-unlock"></span> 开放报名</a>
		        	</div>
		        </td>
      		</tr>
      </c:forEach>
